...
var button = document.getElementById("myButton"); // 버튼의 id를 설정해주세요.
...
const textElementss = document.querySelectorAll("#span1");
...
// 각 텍스트 요소에 Observer 등록
textElementss.forEach((span1) => {
observerts.observe(span1);
});

const textElementss2 = document.querySelectorAll("#span2");

const observerts2 = new IntersectionObserver((entries) => {
entries.forEach((entry) => {
    const text = entry.target;
    const isVisible = entry.intersectionRatio > 0;
...
const textElementss3 = document.querySelectorAll("#span2");

const observerts3 = new IntersectionObserver((entries) => {
entries.forEach((entry) => {
    const text = entry.target;
    const isVisible = entry.intersectionRatio > 0;
...
// 각 텍스트 요소에 Observer 등록
textElementss3.forEach((span2) => {
observerts3.observe(span2);
});
...
const contentPlayElements = document.querySelectorAll("video");
